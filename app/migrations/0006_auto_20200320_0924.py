# Generated by Django 3.0 on 2020-03-20 00:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, verbose_name='サブカテゴリー名')),
        ...
        migrations.AddField(
            model_name='task',
            name='sub_category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.SubCategory', verbose_name='サブカテゴリー'),
        ),
    ]
